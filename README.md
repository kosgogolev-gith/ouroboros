...
| `OUROBOROS_VISION_MODEL_FALLBACK_LIST` | `anthropic/claude-sonnet-4.6,google/gemini-2.5-pro-preview,openai/gpt-4.1` | VLM-specific fallback chain for vision queries |
