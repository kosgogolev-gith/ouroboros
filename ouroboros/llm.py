...
DEFAULT_LIGHT_MODEL = "google/gemini-3.7-flash"
...
class LLMClient:
    ...
    def default_model(self) -> str:
        ...
        return os.environ.get("OUROBOROS_MODEL", "google/gemini-3.7-flash")

    def available_models(self) -> List[str]:
        """Return list of available models from env (for switch_model tool schema)."""
        main = os.environ.get("OUROBOROS_MODEL", "google/gemini-3.7-flash")
